        ...
        <CardFooter className="flex flex-col gap-4">
          ...
          <div className="relative w-full">
            ...
            <div className="relative flex justify-center text-xs uppercase">
              <span className="bg-slate-800 px-2 text-slate-500">o continua con</span>
            </div>
          </div>
          ...
          <Button
            ...
            className="w-full border-slate-700 bg-slate-900/50 hover:bg-slate-700 text-white h-11"
          >
            {isGoogleLoading ? (
              <Loader2 className="h-4 w-4 mr-2 animate-spin" />
            ) : (
